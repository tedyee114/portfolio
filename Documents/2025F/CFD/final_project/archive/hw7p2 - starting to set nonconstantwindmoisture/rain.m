...
nexttile
imagesc(grids.x_p, grids.y_p, reshape(cumulative_moisture_map, N.y_p, N.x_p))
set(gca, 'YDir','normal')
title('cumulative condensed moisture in an area')
colorbar
phi_np1(rainmap==2) = 0; % Reset moisture to 0 where rain is ocurring at this timeframe
