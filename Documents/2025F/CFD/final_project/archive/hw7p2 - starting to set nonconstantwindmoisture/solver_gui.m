...
u_lef_type_dropdown = uidropdown(fig, "Items", ["Dirichlet", "NoFlux (Standard)", "Neumann"]);
...
u_rig_type_dropdown = uidropdown(fig, "Items", ["Neumann", "NoFlux (Standard)", "Dirichlet"]);
...
u_bot_type_dropdown = uidropdown(fig, "Items", [ "NoFlux (Standard)", "Dirichlet", "Neumann"]);
...
u_top_type_dropdown = uidropdown(fig, "Items", [ "NoFlux (Standard)", "Dirichlet", "Neumann"]);
...
v_lef_type_dropdown = uidropdown(fig, "Items", [ "NoFlux (Standard)", "Dirichlet", "Neumann"]);
...
v_rig_type_dropdown = uidropdown(fig, "Items", [ "NoFlux (Standard)", "Dirichlet", "Neumann"]);
...
v_bot_type_dropdown = uidropdown(fig, "Items", ["Dirichlet", "NoFlux (Standard)", "Neumann"]);
...
v_top_type_dropdown = uidropdown(fig, "Items", ["Neumann", "NoFlux (Standard)", "Dirichlet"]);
...
BC.u_rig_value = 0;
BC.u_bot_type = "NoFlux (Standard)";
BC.u_bot_value = 0;
BC.u_top_type = "NoFlux (Standard)";
BC.u_top_value = 0;

BC.v_lef_type = "NoFlux (Standard)";
BC.v_lef_value = 0;
BC.v_rig_type = "NoFlux (Standard)";
BC.v_rig_value = 0;
...
submit_btn = uibutton(fig, 'Text', 'Initialize and Run', 'Position', [10, 220, 120, 30], 'ButtonPushedFcn', @(btn, event) update_plot(fig, grids, N,base, rainshadow));
...
function BC = update_plot(fig, grids, N,base, rainshadow)
    try
        ...
        %% Rainshadow Setup
        if rainshadow == 1
            BC.u_lef_type = "Dirichlet";            % incoming wind
            BC.u_lef_value = 10;
            BC.u_rig_type = "NoFlux (Standard)";    % outlet
            BC.u_rig_value = 0;
            BC.u_bot_type = "Dirichlet";            % no slip at ground
            BC.u_bot_value = 0;         
            BC.u_top_type = "NoFlux (Standard)";    % edge of atmosphere
            BC.u_top_value = 0;
            
            BC.v_lef_type = "Dirichlet";            % all horizontal wind
            BC.v_lef_value = 0;
            BC.v_rig_type = "NoFlux (Standard)";    % outlet
            BC.v_rig_value = 0;
            BC.v_bot_type = "Dirichlet";            % no slip at ground
            BC.v_bot_value = 0;       
            BC.v_top_type = "NoFlux (Standard)";    % edge of atmosphere
            BC.v_top_value = 0;
        end
