...
while II <= II_max && abs(u_change(end)) > u_tol
    ...
    [A_u, b_u] = A_u_creation(u_guess, v_guess, p_guess, dx, dy, dt, Re, u_type, u_prevTime,  A_u, grids, speeds);
    ...
    [A_v, b_v] = A_v_creation(u_guess, v_guess, p_guess, dx, dy, dt, Re, v_type, v_prevTime, A_v, grids, speeds); 
