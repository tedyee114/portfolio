...
% Create the domain
[grids.x_u, grids.y_u, grids.x_v, grids.y_v, grids.x_p, grids.y_p] = grid_generation(dx,dy);
...
% [u_type, v_type, p_type] = set_cell_type(N, grids, cell_visualizations_on_off, panel_1);

[u_type, v_type, p_type] = set_cell_type_blocked(N, grids);